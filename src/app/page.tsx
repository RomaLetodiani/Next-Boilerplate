...
const Header = () => (
  <header className="fixed top-0 left-0 right-0 z-50 border-b border-gray-200 bg-white/80 backdrop-blur-sm dark:border-gray-700 dark:bg-gray-800/80">
    <nav className="container mx-auto flex h-16 items-center justify-between px-4">
      ...
      {/* Mobile menu button */}
      <button className="rounded-lg p-2 text-gray-600 hover:bg-gray-100 md:hidden dark:text-gray-300 dark:hover:bg-gray-700">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="text-left">
              ...
              <p className="mt-6 text-lg text-gray-500 dark:text-gray-300">
                The ultimate starter template for your next project. Built with Next.js 15, React
                19, TypeScript, and Tailwind CSS.
              </p>
            ...
            <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div>
                ...
                <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
                  Build your next great project with our modern Next.js template. Fast, reliable,
