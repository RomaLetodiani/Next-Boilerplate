            ...
            {releases.map((release, index) => (
              <div key={release.version} className="mb-16 last:mb-0">
                ...
                <div className="flex items-center lg:justify-center">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white shadow-lg ring-4 ring-indigo-500/10 dark:ring-indigo-400/10">
